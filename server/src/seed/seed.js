...
const seedDatabase = async () => {
  try {
    ...
    const suppliersData = [
      {
        supplierId: 'SUP-1001',
        supplierName: 'Pfizer Wholesale Corp',
        contactPerson: 'David Miller',
        phone: '+1 (555) 888-1001',
        email: 'orders@pfizer-wholesale.com',
        address: '235 East 42nd St, New York, NY 10017',
      },
      {
        supplierId: 'SUP-1002',
        supplierName: 'Novartis Healthcare Distribution',
        contactPerson: 'Sarah Jenkins',
        phone: '+1 (555) 888-1002',
        email: 'supply@novartis-dist.com',
        address: '1 Health Plaza, East Hanover, NJ 07936',
      },
      {
        supplierId: 'SUP-1003',
        supplierName: 'Cipla Global Therapeutics',
        contactPerson: 'Rajesh Sharma',
        phone: '+1 (555) 888-1003',
        email: 'sales@ciplaglobal.com',
        address: '500 Logistics Parkway, Chicago, IL 60607',
      },
      {
        supplierId: 'SUP-1004',
        supplierName: 'Sun Pharma Logistics',
        contactPerson: 'Michael Chang',
        phone: '+1 (555) 888-1004',
        email: 'support@sunpharma-logistics.com',
        address: '88 Pharmaceutical Way, San Jose, CA 95110',
      },
      {
        supplierId: 'SUP-1005',
        ...
        email: 'orders@gskdirect.com',
        address: '400 Crescent Center Pkwy, Atlanta, GA 30339',
      },
    ];
